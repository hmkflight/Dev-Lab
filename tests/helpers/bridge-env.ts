...
export function environment(){
 const db=new DatabaseSync(':memory:');for(const p of ['0000_tranquil_dust.sql','0001_glorious_boomerang.sql','0002_reflective_slipstream.sql','0003_panoramic_leech.sql','0004_curious_crystal.sql'])db.exec(readFileSync('drizzle/'+p,'utf8'));
