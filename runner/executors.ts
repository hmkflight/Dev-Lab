...
export interface RealPlanInput {type:string;projectSlug:string;clientName?:string;expectedGate?:string;note?:string;runId?:string;approvedBy?:string;selectedTrack?:string;definition?:{intake:Record<string,unknown>;implementation:unknown};}
